...
import { github, homeicon } from "../assets";
...
const ProjectCard = ({ index, name, description, tags, image, source_code_link, website_link}) => {
  ...
  <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
    ...
    >
      ...
      <div className="mt-5">
        <h3 className='text-yellow-400 font-bold text-[24px]'>{name}</h3>
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Those are some of my Project that I have worked on, showcasing my skills.  
        </motion.p>
      </div>
